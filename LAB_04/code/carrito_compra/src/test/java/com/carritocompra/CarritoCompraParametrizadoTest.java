 ...
 *
 * <p>Verifica que la fórmula {@code total = (subtotal - descuento) + impuesto} sea correcta
 * para una amplia variedad de combinaciones de valores.
 */
...
class CarritoCompraParametrizadoTest {
  ...
  /**
   * Verifica el cálculo del total para distintas combinaciones de precio, cantidad,
  ...
  /**
   * Verifica que el subtotal sea correcto para distintas combinaciones de precio y cantidad,
   * sin intervención del servicio de precios.
   */
